...
${NOWDIR}/verify.sh ${NOWDIR}/src/2-0-1.c 123 || exit 1
...
${NOWDIR}/verify.sh ${NOWDIR}/src/2-2-2.c 100 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-3-0.c 10 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-3-1.c 14 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-3-2.c 3 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-4-0.c 1 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-4-1.c 3 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-4-2.c 1 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-4-3.c 2 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-4-4.c 3 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-5-0.c 10 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-6-0.c 32 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-6-1.c 1 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-7-0.c 1 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-7-1.c 2 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-7-2.c 97 || exit 1
${NOWDIR}/verify.sh ${NOWDIR}/src/2-7-3.c 2 || exit 1
